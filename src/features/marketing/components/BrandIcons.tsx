...
/**
 * Real connector brand marks for the hero demo's "synced to your tools" moment.
 * Slack isn't published in simple-icons (Slack asked to be removed over trademark
 * policy), so its mark is drawn locally below — same official four-color "hash".
 */
